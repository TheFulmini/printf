...
/*   Updated: 2021/03/19 14:23:47 by afulmini         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/ft_printf.h"

static void		ft_pre_bigx(t_arg *flags, int *space, int *zero, int *len_x)
{
...
static void		ft_get_bigx(t_arg *flags, char *x, int *len_x)
{
	int	space;
	int	zero;
	int	i;
	...
	i = 0;
	ft_pre_bigx(flags, &space, &zero, len_x);
